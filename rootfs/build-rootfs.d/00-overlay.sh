...
# git cannot track empty directories, so /data is created here — it is the
# mountpoint for the data partition (see installer.d/50-config.sh). Explicit -m
# holds it at 0755 regardless of the build user's umask.
